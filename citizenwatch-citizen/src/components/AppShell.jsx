...
const bottomNavRoutes = ['/home', '/reports', '/public-reports', '/map', '/alerts', '/profile', '/profile/edit'];
...
export default function AppShell({ children }) {
  ...
  const isPublicReportDetailsRoute = /^\/public-reports\/[^/]+$/.test(pathname);
  ...
  const shouldHideFab = hideFabRoutes.includes(pathname) || isReportDetailsRoute || isPublicReportDetailsRoute;
  const shouldShowBottomNav = bottomNavRoutes.includes(pathname) || isReportDetailsRoute || isPublicReportDetailsRoute;
